...
CREATE TABLE `system_menu` (
  ...
  `meta_showparent` tinyint NOT NULL DEFAULT '0' COMMENT '是否显示父级菜单1是0否',
  ...
  `meta_framesrc` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '内嵌的iframe链接',
  `transition_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '当前路由动画效果\r\n当前路由动画效果',
...
INSERT INTO `system_menu` (`id`, `name`, `alias`, `path`, `component`, `redirect`, `url`, `meta_title`, `meta_icon`, `meta_i18n`, `meta_showlink`, `meta_showparent`, `meta_rank`, `meta_keepalive`, `type`, `meta_framesrc`, `transition_name`, `transition_enter`, `transition_leave`, `dynamiclevel`, `refreshredirect`, `extraicon_svg`, `extraicon_name`, `pid`, `state`, `level`, `ctime`) VALUES
(1, 'tabs', 'tabs', '/tabs', '', '/tabs/index', '', 'menus.hstabs', 'IF-team-icontabs', 1, 0, 0, 12, 0, 2, '', '', '', '', 3, '', 0, '', 0, 1, 0, '2022-04-21 18:05:22'),
(2, 'reTabs', 'reTabs', '/tabs/index', '', '', '', 'menus.hstabs', '', 1, 0, 0, 0, 0, 2, '', '', '', '', 3, '', 0, '', 1, 1, 1, '2022-04-21 18:05:36'),
(3, 'tabDetail', 'tabDetail', '/tabs/detail', '', '', '', '', '', 0, 0, 0, 0, 0, 2, '', '', '', '', 3, '/tabs/index', 0, '', 1, 1, 0, '2022-04-21 18:05:37'),
(4, 'iframe', 'iframe', '/iframe', '', '/iframe/pure', '', 'menus.hsExternalPage', 'monitor', 1, 0, 0, 10, 0, 2, '', '', '', '', 3, '', 0, '', 0, 1, 0, '2022-04-21 18:05:40');
...
(5, 'admin3', 'admin123', '297f8efd64f95e37a7d792d926a7b5db47c58403', 'MbBQ', '11111111111', 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif', '', 1, '2022-04-21 03:47:46', '0000-00-00 00:00:00', '', '2019-10-24 20:20:34');
...
--
ALTER TABLE `system_menu`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=5;
