...
1. 采用比较流行开源框架[gin](https://github.com/gin-gonic/gin)、[vue-pure-admi](https://github.com/xiaoxian521/vue-pure-admin)，这些项目采用最新的vue3 vite2 Element-Plus TypeScript等主流技术开发，维护和更新也比较好。
